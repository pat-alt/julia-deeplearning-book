...
dl = DataLoader(dset, batchsize=256)
...
valid_dl = DataLoader(valid_dset, batchsize=256)
...
dict_grad = calc_grad(batch, train_y[1:4], linear1, params)
## weights.grad.mean(),bias.grad

mean(curr_grad[1]), mean(curr_grad[2])
mean(dict_grad[1]["weights"]), mean(dict_grad[1]["bias"])
